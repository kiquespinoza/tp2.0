...
df2 = pd.read_csv(r'C:\Users\eespice\Desktop\tp2\pds\ecommerce_customers_dataset.csv')
df3 = pd.read_csv(r'C:\Users\eespice\Desktop\tp2\pds\ecommerce_order_payments_dataset.csv')
